namespace POS.Repository.Migrations
{
    ...
    public partial class AfterCreatingVM : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PurchaseReceivingId = c.Int(nullable: false),
                        ItemId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Items", t => t.ItemId, cascadeDelete: true)
                .ForeignKey("dbo.PurchaseReceivings", t => t.PurchaseReceivingId, cascadeDelete: true)
